...
# source: nets/protos/mean_stddev_box_coder.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='nets/protos/mean_stddev_box_coder.proto',
  package='nets.protos',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=b'\n\'nets/protos/mean_stddev_box_coder.proto\x12\x0bnets.protos\"*\n\x12MeanStddevBoxCoder\x12\x14\n\x06stddev\x18\x01 \x01(\x02:\x04\x30.01'
)
...
_MEANSTDDEVBOXCODER = _descriptor.Descriptor(
  ...
  full_name='nets.protos.MeanStddevBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stddev', full_name='nets.protos.MeanStddevBoxCoder.stddev', index=0,
...
MeanStddevBoxCoder = _reflection.GeneratedProtocolMessageType('MeanStddevBoxCoder', (_message.Message,), {
  ...
  '__module__' : 'nets.protos.mean_stddev_box_coder_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.MeanStddevBoxCoder)
  })
