...
# source: nets/protos/calibration.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='nets/protos/calibration.proto',
  package='nets.protos',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=b'\n\x1dnets/protos/calibration.proto\x12\x0bnets.protos\"\xa8\x03\n\x11\x43\x61librationConfig\x12\x44\n\x16\x66unction_approximation\x18\x01 \x01(\x0b\x32\".nets.protos.FunctionApproximationH\x00\x12V\n class_id_function_approximations\x18\x02 \x01(\x0b\x32*.nets.protos.ClassIdFunctionApproximationsH\x00\x12>\n\x13sigmoid_calibration\x18\x03 \x01(\x0b\x32\x1f.nets.protos.SigmoidCalibrationH\x00\x12P\n\x1d\x63lass_id_sigmoid_calibrations\x18\x04 \x01(\x0b\x32\'.nets.protos.ClassIdSigmoidCalibrationsH\x00\x12U\n\x1ftemperature_scaling_calibration\x18\x05 \x01(\x0b\x32*.nets.protos.TemperatureScalingCalibrationH\x00\x42\x0c\n\ncalibrator\"@\n\x15\x46unctionApproximation\x12\'\n\tx_y_pairs\x18\x01 \x01(\x0b\x32\x14.nets.protos.XYPairs\"\xd1\x01\n\x1d\x43lassIdFunctionApproximations\x12`\n\x15\x63lass_id_xy_pairs_map\x18\x01 \x03(\x0b\x32\x41.nets.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry\x1aN\n\x16\x43lassIdXyPairsMapEntry\x12\x0b\n\x03key\x18\x01 \x01(\x05\x12#\n\x05value\x18\x02 \x01(\x0b\x32\x14.nets.protos.XYPairs:\x02\x38\x01\"P\n\x12SigmoidCalibration\x12:\n\x12sigmoid_parameters\x18\x01 \x01(\x0b\x32\x1e.nets.protos.SigmoidParameters\"\xf3\x01\n\x1a\x43lassIdSigmoidCalibrations\x12q\n\x1f\x63lass_id_sigmoid_parameters_map\x18\x01 \x03(\x0b\x32H.nets.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry\x1a\x62\n ClassIdSigmoidParametersMapEntry\x12\x0b\n\x03key\x18\x01 \x01(\x05\x12-\n\x05value\x18\x02 \x01(\x0b\x32\x1e.nets.protos.SigmoidParameters:\x02\x38\x01\"/\n\x1dTemperatureScalingCalibration\x12\x0e\n\x06scaler\x18\x01 \x01(\x02\"\x93\x01\n\x07XYPairs\x12-\n\x08x_y_pair\x18\x01 \x03(\x0b\x32\x1b.nets.protos.XYPairs.XYPair\x12\x39\n\x12training_data_type\x18\x02 \x01(\x0e\x32\x1d.nets.protos.TrainingDataType\x1a\x1e\n\x06XYPair\x12\t\n\x01x\x18\x01 \x01(\x02\x12\t\n\x01y\x18\x02 \x01(\x02\"0\n\x11SigmoidParameters\x12\r\n\x01\x61\x18\x01 \x01(\x02:\x02-1\x12\x0c\n\x01\x62\x18\x02 \x01(\x02:\x01\x30*N\n\x10TrainingDataType\x12\x15\n\x11\x44\x41TA_TYPE_UNKNOWN\x10\x00\x12\x0f\n\x0b\x41LL_CLASSES\x10\x01\x12\x12\n\x0e\x43LASS_SPECIFIC\x10\x02'
)

_TRAININGDATATYPE = _descriptor.EnumDescriptor(
  name='TrainingDataType',
  full_name='nets.protos.TrainingDataType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CALIBRATIONCONFIG = _descriptor.Descriptor(
  ...
  full_name='nets.protos.CalibrationConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='function_approximation', full_name='nets.protos.CalibrationConfig.function_approximation', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='class_id_function_approximations', full_name='nets.protos.CalibrationConfig.class_id_function_approximations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sigmoid_calibration', full_name='nets.protos.CalibrationConfig.sigmoid_calibration', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='class_id_sigmoid_calibrations', full_name='nets.protos.CalibrationConfig.class_id_sigmoid_calibrations', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temperature_scaling_calibration', full_name='nets.protos.CalibrationConfig.temperature_scaling_calibration', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='calibrator', full_name='nets.protos.CalibrationConfig.calibrator',
...
_FUNCTIONAPPROXIMATION = _descriptor.Descriptor(
  ...
  full_name='nets.protos.FunctionApproximation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x_y_pairs', full_name='nets.protos.FunctionApproximation.x_y_pairs', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDFUNCTIONAPPROXIMATIONS_CLASSIDXYPAIRSMAPENTRY = _descriptor.Descriptor(
  ...
  full_name='nets.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='nets.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='nets.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDFUNCTIONAPPROXIMATIONS = _descriptor.Descriptor(
  ...
  full_name='nets.protos.ClassIdFunctionApproximations',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_id_xy_pairs_map', full_name='nets.protos.ClassIdFunctionApproximations.class_id_xy_pairs_map', index=0,
...
_SIGMOIDCALIBRATION = _descriptor.Descriptor(
  ...
  full_name='nets.protos.SigmoidCalibration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sigmoid_parameters', full_name='nets.protos.SigmoidCalibration.sigmoid_parameters', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDSIGMOIDCALIBRATIONS_CLASSIDSIGMOIDPARAMETERSMAPENTRY = _descriptor.Descriptor(
  ...
  full_name='nets.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='nets.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='nets.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDSIGMOIDCALIBRATIONS = _descriptor.Descriptor(
  ...
  full_name='nets.protos.ClassIdSigmoidCalibrations',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_id_sigmoid_parameters_map', full_name='nets.protos.ClassIdSigmoidCalibrations.class_id_sigmoid_parameters_map', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TEMPERATURESCALINGCALIBRATION = _descriptor.Descriptor(
  ...
  full_name='nets.protos.TemperatureScalingCalibration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='scaler', full_name='nets.protos.TemperatureScalingCalibration.scaler', index=0,
...
_XYPAIRS_XYPAIR = _descriptor.Descriptor(
  name='XYPair',
  full_name='nets.protos.XYPairs.XYPair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='nets.protos.XYPairs.XYPair.x', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y', full_name='nets.protos.XYPairs.XYPair.y', index=1,
...
_XYPAIRS = _descriptor.Descriptor(
  name='XYPairs',
  full_name='nets.protos.XYPairs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x_y_pair', full_name='nets.protos.XYPairs.x_y_pair', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='training_data_type', full_name='nets.protos.XYPairs.training_data_type', index=1,
...
_SIGMOIDPARAMETERS = _descriptor.Descriptor(
  ...
  full_name='nets.protos.SigmoidParameters',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='a', full_name='nets.protos.SigmoidParameters.a', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='b', full_name='nets.protos.SigmoidParameters.b', index=1,
      number=2, type=2, cpp_type=6, label=1,
...
CalibrationConfig = _reflection.GeneratedProtocolMessageType('CalibrationConfig', (_message.Message,), {
  ...
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.CalibrationConfig)
  })
...
FunctionApproximation = _reflection.GeneratedProtocolMessageType('FunctionApproximation', (_message.Message,), {
  ...
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.FunctionApproximation)
  })
...
ClassIdFunctionApproximations = _reflection.GeneratedProtocolMessageType('ClassIdFunctionApproximations', (_message.Message,), {
  ...
  'ClassIdXyPairsMapEntry' : _reflection.GeneratedProtocolMessageType('ClassIdXyPairsMapEntry', (_message.Message,), {
    ...
    '__module__' : 'nets.protos.calibration_pb2'
    # @@protoc_insertion_point(class_scope:nets.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry)
    })
  ,
  'DESCRIPTOR' : _CLASSIDFUNCTIONAPPROXIMATIONS,
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.ClassIdFunctionApproximations)
  })
...
SigmoidCalibration = _reflection.GeneratedProtocolMessageType('SigmoidCalibration', (_message.Message,), {
  ...
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.SigmoidCalibration)
  })
...
ClassIdSigmoidCalibrations = _reflection.GeneratedProtocolMessageType('ClassIdSigmoidCalibrations', (_message.Message,), {
  ...
  'ClassIdSigmoidParametersMapEntry' : _reflection.GeneratedProtocolMessageType('ClassIdSigmoidParametersMapEntry', (_message.Message,), {
    ...
    '__module__' : 'nets.protos.calibration_pb2'
    # @@protoc_insertion_point(class_scope:nets.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry)
    })
  ,
  'DESCRIPTOR' : _CLASSIDSIGMOIDCALIBRATIONS,
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.ClassIdSigmoidCalibrations)
  })
...
TemperatureScalingCalibration = _reflection.GeneratedProtocolMessageType('TemperatureScalingCalibration', (_message.Message,), {
  ...
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.TemperatureScalingCalibration)
  })
...
XYPairs = _reflection.GeneratedProtocolMessageType('XYPairs', (_message.Message,), {
  ...
  'XYPair' : _reflection.GeneratedProtocolMessageType('XYPair', (_message.Message,), {
    ...
    '__module__' : 'nets.protos.calibration_pb2'
    # @@protoc_insertion_point(class_scope:nets.protos.XYPairs.XYPair)
    })
  ,
  'DESCRIPTOR' : _XYPAIRS,
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.XYPairs)
  })
...
SigmoidParameters = _reflection.GeneratedProtocolMessageType('SigmoidParameters', (_message.Message,), {
  ...
  '__module__' : 'nets.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:nets.protos.SigmoidParameters)
  })
