...
from nets.models.efficientnet import base_config
from nets.models.efficientnet import common_modules
from nets.models.efficientnet import preprocessing
from nets.models.efficientnet import tf_utils
...
def efficientnet(image_input: tf.keras.layers.Input, config: ModelConfig):
    ...
    for stack_idx, block in enumerate(blocks):
        ...
        block = block.replace(input_filters=round_filters(block.input_filters, config),
...
class EfficientNet(tf.keras.Model):
    ...
    def __init__(self,
        ...
        super(EfficientNet, self).__init__(inputs=image_input, outputs=output, name=model_name)
    ...
    def from_name(cls,
        ...
        if model_weights_path:
            common_modules.load_weights(model, model_weights_path, weights_format=weights_format)
