...
from nets.models import bidirectional_feature_pyramid_generators as bifpn_generators
from nets.utils import ops
from nets.utils import shape_utils
from nets.utils import tf_version

# pylint: disable=g-import-not-at-top
if tf_version.is_tf2():
    from nets.models.efficientnet import efficientnet_model

_EFFICIENTNET_LEVEL_ENDPOINTS = {1: 'stack_0/block_0/project_bn',
...
class SSDEfficientNetBiFPNKerasFeatureExtractor(
    ...
    def __init__(self,
        ...
        self._backbone_max_level = min(max(_EFFICIENTNET_LEVEL_ENDPOINTS.keys()), bifpn_max_level)
