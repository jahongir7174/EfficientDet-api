...
from nets.box_coders import faster_rcnn_box_coder
from nets.protos import box_coder_pb2
...
def build(box_coder_config):
    ...
    if box_coder_config.WhichOneof('box_coder_oneof') == 'faster_rcnn_box_coder':
        return faster_rcnn_box_coder.FasterRcnnBoxCoder([box_coder_config.faster_rcnn_box_coder.y_scale,
