...
from nets.core import box_coder
from nets.core import box_list
from nets.core import matcher as mat
from nets.core import region_similarity_calculator as sim_calc
...
def batch_assign(target_assigner,
    ...
    return (batch_cls_targets, batch_cls_weights, batch_reg_targets, batch_reg_weights, batch_match)
